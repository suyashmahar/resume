...
\begin{enumerate}
        \item \textbf{Characterizing CXL Devices and Failures}\hfill{}May 2023-Present\\
    \textit{UC San Diego and UIUC}\vspace{-0.15cm}
    \begin{enumerate}[itemsep=\projitemsep]
            \item Characterizing CXL memory expanders and FPGAs for a variety of workloads and microbenchmarks.
            \item Worked on classifying CXL shared memory failure modes.
    ...
    \begin{enumerate}[itemsep=\projitemsep]
            ...
            \item Implemented safety through new memory protection features while avoiding serialization by passing ptrs over SHM.
            \item Addressed scalability limitations of CXL by integrating RDMA-based communication. \end{enumerate}
...
\begin{tabular}{p{\durlen} p{\deslen}}
  ...
  \centering Present      & \vspace{-0.6cm}\begin{itemize}[itemsep=\workexitemsep]
          \item Mentoring undergrads, Drawin Chen and Nirmal Agnihotri on getting started with CS research.
          \item Working with WebAssembly and persistent memory for serverless computing environment.
